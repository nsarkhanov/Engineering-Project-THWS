...
export class HistoricalChartComponent {
  ...
  buildIMUChartComponent(graphNumber: number) {
    ...
    for (let i = 0; i < this.imuAxes.length; ++i) {
      ...
      // var coordinate2 = 2;
      // var valueline2 = d3.line<IMUSensorData>()
      //   .x(function (d: IMUSensorData) {
      //       return chartProps.x(d.date.getTime());
      //   })
      //   .y(function (d: IMUSensorData) { 
      //     switch(graphNumber) {
      //       case 1: 
      //         return chartProps.y(d.acceleration[coordinate2-1]);
      //       case 2: 
      //         return chartProps.y(d.orientation[coordinate2-1]);
      //       case 3: 
      //         return chartProps.y(d.gyro[coordinate2-1]);
      //       case 4:
      //         return chartProps.y(d.magnetic[coordinate2-1]);
      //       case 5:
      //         return chartProps.y(d.linear[coordinate2-1]);
      //       case 6:
      //         return chartProps.y(d.gravity[coordinate2-1]);
      //       default:
      //         throw new Error("Trying to plot imu data but data does not have any brain data (acceleration, orientation,...)");
      //   }
      // });   
